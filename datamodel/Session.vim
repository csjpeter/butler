...
set shortmess=aoO
badd +36 dist/src/butler_item.cpp
badd +1 dist/src/butler_queryoptions.cpp
badd +1 dist/src/butler_tag.cpp
badd +1 dist/src/butler_tag_set.cpp
badd +1 dist/src/butler_db.h
badd +1 dist/src/butler_item_db.h
badd +1 dist/src/butler_item.h
...
exe 'vert 2resize ' . ((&columns * 23 + 90) / 180)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
let s:l = 41 - ((40 * winheight(0) + 75) / 150)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 1 - ((0 * winheight(0) + 75) / 150)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1
...
exe 'vert 1resize ' . ((&columns * 24 + 90) / 180)
exe 'vert 2resize ' . ((&columns * 23 + 90) / 180)
tabedit dist/src/butler_queryoptions.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 94 + 90) / 180)
exe 'vert 2resize ' . ((&columns * 85 + 90) / 180)
argglobal
2argu
setlocal keymap=
setlocal noarabic
...
argglobal
2argu
edit dist/src/butler_queryoptions.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
exe 'vert 1resize ' . ((&columns * 94 + 90) / 180)
exe 'vert 2resize ' . ((&columns * 85 + 90) / 180)
tabedit dist/src/butler_tag.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 2resize ' . ((&columns * 94 + 90) / 180)
exe '3resize ' . ((&lines * 14 + 24) / 48)
exe 'vert 3resize ' . ((&columns * 85 + 90) / 180)
exe '4resize ' . ((&lines * 30 + 24) / 48)
exe 'vert 4resize ' . ((&columns * 85 + 90) / 180)
argglobal
3argu
setlocal keymap=
setlocal noarabic
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 45 - ((13 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
argglobal
3argu
edit dist/src/butler_tag_set.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 41 - ((24 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
41
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 31 - ((13 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 50 - ((23 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
50
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 25 - ((11 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
25
...
exe 'vert 2resize ' . ((&columns * 85 + 90) / 180)
argglobal
edit dist/src/butler_debug.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 19 - ((5 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 10 - ((4 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 43 - ((17 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
