...
badd +1 src/butler_queryoptions.h
...
badd +0 src/butler_algorithms.h
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 34 - ((7 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 21 - ((13 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
