...
setlocal wrap
setlocal wrapmargin=0
let s:l = 48 - ((14 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 33 - ((20 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
...
exe '3resize ' . ((&lines * 30 + 24) / 48)
exe 'vert 3resize ' . ((&columns * 49 + 90) / 180)
exe '4resize ' . ((&lines * 30 + 24) / 48)
exe 'vert 4resize ' . ((&columns * 80 + 90) / 180)
argglobal
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 35 - ((13 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
